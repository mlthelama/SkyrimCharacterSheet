...
def make_rel_archive(a_args):
	...
	archive.write(
		os.path.join(a_args.src_dir, "mcm", "ShowStats.esp"),
        "ShowStats.esp")
	archive.write(
		os.path.join(a_args.src_dir, "mcm", "scripts", "ShowStats.pex"),
        "Scripts/ShowStats.pex")
	archive.write(
		os.path.join(a_args.src_dir, "mcm", "scripts", "ShowStats_MCM.pex"),
        "Scripts/ShowStats_MCM.pex")
