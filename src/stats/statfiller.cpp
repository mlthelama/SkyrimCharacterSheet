...
std::vector<std::shared_ptr<StatItem>> Filler::getData() {
    std::vector<std::shared_ptr<StatItem>> statList = {
        ...
        std::make_shared<StatItem>(StatsValue::resistDamage, ActorValue::kDamageResist, *Settings::resistDamageString,
        ...
        std::make_shared<StatItem>(StatsValue::resistPoison, ActorValue::kPoisonResist, *Settings::resistPoisonString,
            *Settings::resistPoisonStringEnding, *Settings::resistPoison, getStatsMenu(*Settings::resistPoisonMenu)),
        ...
        std::make_shared<StatItem>(StatsValue::absorbChance, ActorValue::kAbsorbChance, *Settings::absorbChanceString,
            *Settings::absorbChanceStringEnding, *Settings::absorbChance, getStatsMenu(*Settings::absorbChanceMenu)),
        ...
        std::make_shared<StatItem>(StatsValue::armorPerks, ActorValue::kArmorPerks, *Settings::armorPerksString,
            *Settings::armorPerksStringEnding, *Settings::armorPerks, getStatsMenu(*Settings::armorPerksMenu), false,
        ...
        std::make_shared<StatItem>(StatsValue::shoutRecoveryMult, ActorValue::kShoutRecoveryMult,
            *Settings::shoutRecoveryMultString, *Settings::shoutRecoveryMultStringEnding, *Settings::shoutRecoveryMult,
            getStatsMenu(*Settings::shoutRecoveryMultMenu), false, getMultiplier(*Settings::shoutRecoveryMultMult)),
        std::make_shared<StatItem>(StatsValue::movementNoiseMult, ActorValue::kMovementNoiseMult,
            *Settings::movementNoiseMultString, *Settings::movementNoiseMultStringEnding, *Settings::movementNoiseMult,
            getStatsMenu(*Settings::movementNoiseMultMenu), false, getMultiplier(*Settings::movementNoiseMultMult)),
        ...
        std::make_shared<StatItem>(StatsValue::xp, ActorValue::kNone, *Settings::xpString, *Settings::xpStringEnding,
            *Settings::xp, StatsMenuValue::mNone, true),
        ...
        std::make_shared<StatItem>(StatsValue::marksmanMod, ActorValue::kMarksmanModifier, *Settings::archeryModString,
        ...
        std::make_shared<StatItem>(StatsValue::smithingMod, ActorValue::kSmithingModifier, *Settings::smithingModString,
        ...
        std::make_shared<StatItem>(StatsValue::sneakingMod, ActorValue::kSneakingModifier, *Settings::sneakModString,
            *Settings::sneakModStringEnding, *Settings::sneakMod, getStatsMenu(*Settings::sneakModMenu)),
        std::make_shared<StatItem>(StatsValue::alchemyMod, ActorValue::kAlchemyModifier, *Settings::alchemyModString,
        ...
        std::make_shared<StatItem>(StatsValue::illusionMod, ActorValue::kIllusionModifier, *Settings::illusionModString,
