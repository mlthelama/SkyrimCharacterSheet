...
std::string Faction::getDarkBrotherhoodRank() {
...
std::string Faction::getGraybeardRank() { return *Settings::ysmirRank; }

std::string Faction::getImperialLegionRank() {
    auto rank = undefined;
...
std::string Faction::getStormcloaksRank() {
    auto rank = undefined;
...
std::string Faction::getVolkiharVampireClanRank() { return *Settings::vampireLordRank; }

std::string Faction::getDawnguardRank() { return *Settings::vampireHunterRank; }

std::string Faction::getHouseTelvanniRank() { return *Settings::honoraryMemberRank; }