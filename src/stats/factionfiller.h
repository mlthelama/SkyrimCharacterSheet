...
public:
    ...
    std::vector<std::shared_ptr<FactionItem>> getData() {
        std::vector<std::shared_ptr<FactionItem>> factionList = {
            ...
            std::make_shared<FactionItem>(FactionValue::thiefsGuild, *Settings::thiefsGuildString,
                *Settings::showFactions, getFactionMenu(*Settings::factionMenu)),
            ...
            std::make_shared<FactionItem>(FactionValue::collegeOfWinterhold, *Settings::collegeOfWinterholdString,
                *Settings::showFactions, getFactionMenu(*Settings::factionMenu)),
            std::make_shared<FactionItem>(FactionValue::companions, *Settings::companionsString,
                *Settings::showFactions, getFactionMenu(*Settings::factionMenu)),
            std::make_shared<FactionItem>(FactionValue::imperialLegion, *Settings::imperialLegionString,
                *Settings::showFactions, getFactionMenu(*Settings::factionMenu)),
            std::make_shared<FactionItem>(FactionValue::stormcloaks, *Settings::stormcloaksString,
                *Settings::showFactions, getFactionMenu(*Settings::factionMenu)),
            ...
            std::make_shared<FactionItem>(FactionValue::clavicusVile, *Settings::clavicusVileName,
                *Settings::showChampion, getFactionMenu(*Settings::championMenu), true),
            std::make_shared<FactionItem>(FactionValue::hermaeusMora, *Settings::hermaeusMoraName,
                *Settings::showChampion, getFactionMenu(*Settings::championMenu), true),
