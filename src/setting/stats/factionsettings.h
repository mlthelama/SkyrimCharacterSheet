...
public:
    [[nodiscard]] static faction_map load() {
        auto faction_menu = menu_util::get_faction_menu(ini_setting::get_faction_menu());
        auto thane_menu = menu_util::get_faction_menu(ini_setting::get_thane_menu());
        auto champion_menu = menu_util::get_faction_menu(ini_setting::get_champion_menu());
