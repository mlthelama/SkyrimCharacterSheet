...
public:
    ...
    [[nodiscard]] static stats_map load() {
        ...
        if (ini_setting::get_show_resistance_cap()) {
            game_setting->set_settings();
        }

        auto* mod_manager = mod::mod_manager::get_singleton();

        auto get_display_type = value_util::get_display_actor_value_type(ini_setting::get_display_av_type());
        ...
        mp[stats_value::height] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::height,
            ini_setting::get_height_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_height_menu()),
            stats_inventory_menu_value::m_none);
        mp[stats_value::equipped_weight] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::equipped_weight,
            ini_setting::get_equipped_weight_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_equiped_weight_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_equipped_weight_menu_inventory()),
            icon_keys::equipped_weight);
        mp[stats_value::weight] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::weight,
            ini_setting::get_weight_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_weight_menu()),
            stats_inventory_menu_value::m_none,
            icon_keys::weight);
        mp[stats_value::armor] = std::make_unique<stat_config>(actor_value::kDamageResist,
            menu_keys::armor,
            menu_util::get_stats_menu(ini_setting::get_armor_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_armor_menu_inventory()),
            icon_keys::armor);
        mp[stats_value::damage] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::damage,
            menu_util::get_stats_menu(ini_setting::get_damage_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_damage_menu_inventory()),
            icon_keys::damage);
        mp[stats_value::skill_trainings_this_level] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::trainings_level,
            menu_util::get_stats_menu(ini_setting::get_skill_trainings_this_level_menu()),
            stats_inventory_menu_value::m_none,
            icon_keys::trainings_level);
        mp[stats_value::health] = std::make_unique<stat_config>(actor_value::kHealth,
            menu_keys::health,
            menu_util::get_stats_menu(ini_setting::get_health_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_health_menu_inventory()),
            get_display_type,
            icon_keys::health);
        mp[stats_value::health_rate_per] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::health_rate,
            ini_setting::get_health_rate_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_health_rate_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_health_rate_menu_inventory()),
            icon_keys::health_rate);
        mp[stats_value::magicka] = std::make_unique<stat_config>(actor_value::kMagicka,
            menu_keys::magicka,
            menu_util::get_stats_menu(ini_setting::get_magicka_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_magicka_menu_inventory()),
            get_display_type,
            icon_keys::magicka);
        mp[stats_value::magicka_rate_per] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::magicka_rate,
            ini_setting::get_magicka_rate_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_magicka_rate_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_magicka_rate_menu_inventory()),
            icon_keys::magicka_rate);
        mp[stats_value::stamina] = std::make_unique<stat_config>(actor_value::kStamina,
            menu_keys::stamina,
            menu_util::get_stats_menu(ini_setting::get_stamina_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_stamina_menu_inventory()),
            get_display_type,
            icon_keys::stamina);
        mp[stats_value::stamina_rate_per] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::stamina_rate,
            ini_setting::get_stamina_rate_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_stamina_rate_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_stamina_rate_menu_inventory()),
            icon_keys::stamina_rate);
        mp[stats_value::resist_damage] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::resist_damage,
            ini_setting::get_resist_damage_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_resist_damage_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_resist_damage_menu_inventory()),
            const_static_multiplier,
            game_setting->get_max_armor_resistance(),
        ...
        mp[stats_value::resist_disease] = std::make_unique<stat_config>(actor_value::kResistDisease,
            ...
            ini_setting::get_resist_disease_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_resist_disease_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_resist_disease_menu_inventory()),
        ...
        mp[stats_value::resist_poison] = std::make_unique<stat_config>(actor_value::kPoisonResist,
            ...
            ini_setting::get_resist_poison_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_resist_poison_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_resist_poison_menu_inventory()),
            const_static_multiplier,
            game_setting->get_max_resistance(),
        ...
        mp[stats_value::resist_fire] = std::make_unique<stat_config>(actor_value::kResistFire,
            ...
            ini_setting::get_resist_fire_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_resist_fire_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_resist_fire_menu_inventory()),
            const_static_multiplier,
            game_setting->get_max_resistance(),
        ...
        mp[stats_value::resist_shock] = std::make_unique<stat_config>(actor_value::kResistShock,
            ...
            ini_setting::get_resist_shock_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_resist_shock_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_resist_shock_menu_inventory()),
            const_static_multiplier,
            game_setting->get_max_resistance(),
        ...
        mp[stats_value::resist_frost] = std::make_unique<stat_config>(actor_value::kResistFrost,
            ...
            ini_setting::get_resist_frost_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_resist_frost_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_resist_frost_menu_inventory()),
            const_static_multiplier,
            game_setting->get_max_resistance(),
        ...
        mp[stats_value::resist_magic] = std::make_unique<stat_config>(actor_value::kResistMagic,
            ...
            ini_setting::get_resist_magic_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_resist_magic_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_resist_magic_menu_inventory()),
            const_static_multiplier,
            game_setting->get_max_resistance(),
            icon_keys::resist_magic);
        mp[stats_value::one_handed] = std::make_unique<stat_config>(actor_value::kOneHanded,
            menu_keys::one_handed,
            menu_util::get_stats_menu(ini_setting::get_one_handed_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_one_handed_menu_inventory()),
            get_display_type,
            icon_keys::one_handed);
        mp[stats_value::two_handed] = std::make_unique<stat_config>(actor_value::kTwoHanded,
            menu_keys::two_handed,
            menu_util::get_stats_menu(ini_setting::get_two_handed_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_two_handed_menu_inventory()),
            get_display_type,
            icon_keys::two_handed);
        mp[stats_value::archery] = std::make_unique<stat_config>(actor_value::kArchery,
            menu_keys::archery,
            menu_util::get_stats_menu(ini_setting::get_archery_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_archery_menu_inventory()),
            get_display_type,
            icon_keys::archery);
        mp[stats_value::block] = std::make_unique<stat_config>(actor_value::kBlock,
            menu_keys::block,
            menu_util::get_stats_menu(ini_setting::get_block_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_block_menu_inventory()),
            get_display_type,
            icon_keys::block);
        mp[stats_value::smithing] = std::make_unique<stat_config>(actor_value::kSmithing,
            menu_keys::smithing,
            menu_util::get_stats_menu(ini_setting::get_smithing_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_smithing_menu_inventory()),
            get_display_type,
            icon_keys::smithing);
        mp[stats_value::heavy_armor] = std::make_unique<stat_config>(actor_value::kHeavyArmor,
            menu_keys::heavy_armor,
            menu_util::get_stats_menu(ini_setting::get_heavy_armor_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_heavy_armor_menu_inventory()),
            get_display_type,
            icon_keys::heavy_armor);
        mp[stats_value::light_armor] = std::make_unique<stat_config>(actor_value::kLightArmor,
            menu_keys::light_armor,
            menu_util::get_stats_menu(ini_setting::get_light_armor_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_light_armor_menu_inventory()),
            get_display_type,
        ...
        if (mod_manager->get_hand_to_hand()) {
            mp[stats_value::pickpocket] = std::make_unique<stat_config>(actor_value::kPickpocket,
                menu_keys::security,
                menu_util::get_stats_menu(ini_setting::get_pickpocket_menu()),
                menu_util::get_stats_inventory_menu(ini_setting::get_pickpocket_menu_inventory()),
                get_display_type,
                icon_keys::security);
            mp[stats_value::lockpicking] = std::make_unique<stat_config>(actor_value::kLockpicking,
                menu_keys::hand_to_hand,
                menu_util::get_stats_menu(ini_setting::get_lockpicking_menu()),
                menu_util::get_stats_inventory_menu(ini_setting::get_lockpicking_menu_inventory()),
                get_display_type,
        ...
        mp[stats_value::sneak] = std::make_unique<stat_config>(actor_value::kSneak,
            menu_keys::sneak,
            menu_util::get_stats_menu(ini_setting::get_sneak_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_sneak_menu_inventory()),
            get_display_type,
            icon_keys::sneak);
        mp[stats_value::alchemy] = std::make_unique<stat_config>(actor_value::kAlchemy,
            menu_keys::alchemy,
            menu_util::get_stats_menu(ini_setting::get_alchemy_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_alchemy_menu_inventory()),
            get_display_type,
            icon_keys::alchemy);
        mp[stats_value::speech] = std::make_unique<stat_config>(actor_value::kSpeech,
            menu_keys::speech,
            menu_util::get_stats_menu(ini_setting::get_speech_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_speech_menu_inventory()),
            get_display_type,
            icon_keys::speech);
        mp[stats_value::enchanting] = std::make_unique<stat_config>(actor_value::kEnchanting,
            menu_keys::enchanting,
            menu_util::get_stats_menu(ini_setting::get_enchanting_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_enchanting_menu_inventory()),
            get_display_type);
        mp[stats_value::alteration] = std::make_unique<stat_config>(actor_value::kAlteration,
            menu_keys::alteration,
            menu_util::get_stats_menu(ini_setting::get_alteration_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_alteration_menu_inventory()),
            get_display_type,
            icon_keys::alteration);
        mp[stats_value::conjuration] = std::make_unique<stat_config>(actor_value::kConjuration,
            menu_keys::conjuration,
            menu_util::get_stats_menu(ini_setting::get_conjuration_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_conjuration_menu_inventory()),
            get_display_type,
        ...
        mp[stats_value::destruction] = std::make_unique<stat_config>(actor_value::kDestruction,
            ...
            menu_util::get_stats_menu(ini_setting::get_destruction_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_destruction_menu_inventory()),
            get_display_type,
            icon_keys::destruction);
        mp[stats_value::illusion] = std::make_unique<stat_config>(actor_value::kIllusion,
            menu_keys::illusion,
            menu_util::get_stats_menu(ini_setting::get_illusion_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_illusion_menu_inventory()),
            get_display_type,
            icon_keys::illusion);
        mp[stats_value::restoration] = std::make_unique<stat_config>(actor_value::kRestoration,
            menu_keys::restoration,
            menu_util::get_stats_menu(ini_setting::get_restoration_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_restoration_menu_inventory()),
            get_display_type,
        ...
        mp[stats_value::one_handed_power_mod] = std::make_unique<stat_config>(actor_value::kOneHandedPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_one_handed_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_one_handed_power_mod_menu_inventory()),
        ...
        mp[stats_value::two_handed_power_mod] = std::make_unique<stat_config>(actor_value::kTwoHandedPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_two_handed_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_two_handed_power_mod_menu_inventory()),
        ...
        mp[stats_value::archery_power_mod] = std::make_unique<stat_config>(actor_value::kMarksmanPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_archery_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_archery_power_mod_menu_inventory()),
        ...
        mp[stats_value::block_power_mod] = std::make_unique<stat_config>(actor_value::kBlockPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_block_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_block_power_mod_menu_inventory()),
        ...
        mp[stats_value::smithing_power_mod] = std::make_unique<stat_config>(actor_value::kSmithingPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_smithing_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_smithing_power_mod_menu_inventory()),
        ...
        mp[stats_value::heavy_armor_power_mod] = std::make_unique<stat_config>(actor_value::kHeavyArmorPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_heavy_armor_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_heavy_armor_power_mod_menu_inventory()),
        ...
        mp[stats_value::light_armor_power_mod] = std::make_unique<stat_config>(actor_value::kLightArmorPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_light_armor_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_light_armor_power_mod_menu_inventory()),
        ...
        if (mod_manager->get_hand_to_hand()) {
            mp[stats_value::pickpocket_power_mod] = std::make_unique<stat_config>(actor_value::kPickpocketPowerModifier,
                ...
                menu_util::get_stats_menu(ini_setting::get_pickpocket_power_mod_menu()),
                menu_util::get_stats_inventory_menu(ini_setting::get_pickpocket_power_mod_menu_inventory()),
            ...
            mp[stats_value::lockpicking_power_mod] =
                std::make_unique<stat_config>(actor_value::kLockpickingPowerModifier,
                    ...
                    menu_util::get_stats_menu(ini_setting::get_lockpicking_power_mod_menu()),
                    menu_util::get_stats_inventory_menu(ini_setting::get_lockpicking_power_mod_menu_inventory()),
        ...
        mp[stats_value::sneak_power_mod] = std::make_unique<stat_config>(actor_value::kSneakingPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_sneak_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_sneak_power_mod_menu_inventory()),
        ...
        mp[stats_value::alchemy_power_mod] = std::make_unique<stat_config>(actor_value::kAlchemyPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_alchemy_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_alchemy_power_mod_menu_inventory()),
        ...
        mp[stats_value::speech_power_mod] = std::make_unique<stat_config>(actor_value::kSpeechcraftPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_speech_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_speech_power_mod_menu_inventory()),
        ...
        mp[stats_value::enchanting_power_mod] = std::make_unique<stat_config>(actor_value::kEnchantingPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_enchanting_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_enchanting_power_mod_menu_inventory()),
        ...
        mp[stats_value::alteration_power_mod] = std::make_unique<stat_config>(actor_value::kAlterationPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_alteration_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_alteration_power_mod_menu_inventory()),
        ...
        mp[stats_value::conjuration_power_mod] = std::make_unique<stat_config>(actor_value::kConjurationPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_conjuration_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_conjuration_power_mod_menu_inventory()),
        ...
        mp[stats_value::destruction_power_mod] = std::make_unique<stat_config>(actor_value::kDestructionPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_destruction_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_destruction_power_mod_menu_inventory()),
        ...
        mp[stats_value::illusion_power_mod] = std::make_unique<stat_config>(actor_value::kIllusionPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_illusion_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_illusion_power_mod_menu_inventory()),
        ...
        mp[stats_value::restoration_power_mod] = std::make_unique<stat_config>(actor_value::kRestorationPowerModifier,
            ...
            menu_util::get_stats_menu(ini_setting::get_restoration_power_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_restoration_power_mod_menu_inventory()),
        ...
        mp[stats_value::speed_mult] = std::make_unique<stat_config>(actor_value::kSpeedMult,
            ...
            ini_setting::get_speed_mult_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_speed_mult_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_speed_mult_menu_inventory()),
        ...
        mp[stats_value::inventory_weight] = std::make_unique<stat_config>(actor_value::kInventoryWeight,
            ...
            ini_setting::get_inventory_weight_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_inventory_weight_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_inventory_weight_menu_inventory()),
        ...
        mp[stats_value::carry_weight] = std::make_unique<stat_config>(actor_value::kCarryWeight,
            ...
            ini_setting::get_carry_weight_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_carry_weight_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_carry_weight_menu_inventory()),
        ...
        mp[stats_value::critical_chance] = std::make_unique<stat_config>(actor_value::kCriticalChance,
            ...
            ini_setting::get_critical_chance_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_critical_chance_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_critical_chance_menu_inventory()),
        ...
        mp[stats_value::melee_damage] = std::make_unique<stat_config>(actor_value::kMeleeDamage,
            ...
            menu_util::get_stats_menu(ini_setting::get_melee_damage_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_melee_damage_menu_inventory()),
        ...
        mp[stats_value::unarmed_damage] = std::make_unique<stat_config>(actor_value::kUnarmedDamage,
            ...
            menu_util::get_stats_menu(ini_setting::get_unarmed_damage_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_unarmed_damage_menu_inventory()),
        ...
        mp[stats_value::absorb_chance] = std::make_unique<stat_config>(actor_value::kAbsorbChance,
            ...
            ini_setting::get_absorb_chance_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_absorb_chance_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_absorb_chance_menu_inventory()),
        ...
        mp[stats_value::weapon_speed_mult] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            ini_setting::get_weapon_speed_mult_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_weapon_speed_mult_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_weapon_speed_mult_menu_inventory()),
            menu_util::get_multiplier(ini_setting::get_weapon_speed_mult_mult()),
        ...
        mp[stats_value::left_weapon_speed_mult] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            ini_setting::get_left_weapon_speed_mult_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_left_weapon_speed_mult_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_left_weapon_speed_mult_menu_inventory()),
            menu_util::get_multiplier(ini_setting::get_left_weapon_speed_mult_mult()),
        ...
        mp[stats_value::right_item_charge] = std::make_unique<stat_config>(actor_value::kRightItemCharge,
            ...
            menu_util::get_stats_menu(ini_setting::get_right_item_charge_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_right_item_charge_menu_inventory()),
        ...
        mp[stats_value::left_item_charge] = std::make_unique<stat_config>(actor_value::kLeftItemCharge,
            ...
            menu_util::get_stats_menu(ini_setting::get_left_item_charge_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_left_item_charge_menu_inventory()),
        ...
        mp[stats_value::armor_perks] = std::make_unique<stat_config>(actor_value::kArmorPerks,
            ...
            ini_setting::get_armor_perks_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_armor_perks_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_armor_perks_menu_inventory()),
            menu_util::get_multiplier(ini_setting::get_armor_perks_mult()),
            icon_keys::armor_perks);
        mp[stats_value::mass] = std::make_unique<stat_config>(actor_value::kMass,
            menu_keys::mass,
            menu_util::get_stats_menu(ini_setting::get_mass_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_mass_menu_inventory()),
            icon_keys::mass);
        mp[stats_value::bow_stagger_bonus] = std::make_unique<stat_config>(actor_value::kBowStaggerBonus,
            menu_keys::bow_stagger_bonus,
            menu_util::get_stats_menu(ini_setting::get_bow_stagger_bonus_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_bow_stagger_bonus_menu_inventory()),
        ...
        mp[stats_value::bypass_vendor_keyword_check] =
            std::make_unique<stat_config>(actor_value::kBypassVendorKeywordCheck,
                ...
                menu_util::get_stats_menu(ini_setting::get_bypass_vendor_keyword_check_menu()),
                stats_inventory_menu_value::m_none,
        ...
        mp[stats_value::bypass_vendor_stolen_check] =
            std::make_unique<stat_config>(actor_value::kBypassVendorStolenCheck,
                ...
                menu_util::get_stats_menu(ini_setting::get_bypass_vendor_stolen_check_menu()),
                stats_inventory_menu_value::m_none,
        ...
        mp[stats_value::bow_speed_bonus] = std::make_unique<stat_config>(actor_value::kBowSpeedBonus,
            ...
            ini_setting::get_bow_speed_bonus_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_bow_speed_bonus_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_bow_speed_bonus_menu_inventory()),
        ...
        mp[stats_value::shout_recovery_mult] = std::make_unique<stat_config>(actor_value::kShoutRecoveryMult,
            ...
            ini_setting::get_shout_recovery_mult_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_shout_recovery_mult_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_shout_recovery_mult_menu_inventory()),
            menu_util::get_multiplier(ini_setting::get_shout_recovery_mult_mult()),
        ...
        mp[stats_value::movement_noise_mult] = std::make_unique<stat_config>(actor_value::kMovementNoiseMult,
            ...
            ini_setting::get_movement_noise_mult_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_movement_noise_mult_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_movement_noise_mult_menu_inventory()),
            menu_util::get_multiplier(ini_setting::get_movement_noise_mult_mult()),
        ...
        mp[stats_value::dragon_souls] = std::make_unique<stat_config>(actor_value::kDragonSouls,
            ...
            menu_util::get_stats_menu(ini_setting::get_dragon_souls_menu()),
            stats_inventory_menu_value::m_none,
        ...
        mp[stats_value::combat_health_regen_multiply] =
            std::make_unique<stat_config>(actor_value::kCombatHealthRegenMultiply,
                ...
                ini_setting::get_combat_health_regen_multiply_string_ending(),
                menu_util::get_stats_menu(ini_setting::get_combat_health_regen_multiply_menu()),
                stats_inventory_menu_value::m_none,
                menu_util::get_multiplier(ini_setting::get_combat_health_regen_multiply_mult()),
        ...
        mp[stats_value::attack_damage_mult] = std::make_unique<stat_config>(actor_value::kAttackDamageMult,
            ...
            ini_setting::get_attack_damage_mult_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_attack_damage_mult_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_attack_damage_mult_menu_inventory()),
        ...
        mp[stats_value::reflect_damage] = std::make_unique<stat_config>(actor_value::kReflectDamage,
            ...
            ini_setting::get_reflect_damage_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_reflect_damage_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_reflect_damage_menu_inventory()),
        ...
        mp[stats_value::one_handed_mod] = std::make_unique<stat_config>(actor_value::kOneHandedModifier,
            ...
            ini_setting::get_one_handed_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_one_handed_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_one_handed_mod_menu_inventory()),
        ...
        mp[stats_value::two_handed_mod] = std::make_unique<stat_config>(actor_value::kTwoHandedModifier,
            ...
            ini_setting::get_two_handed_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_two_handed_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_two_handed_mod_menu_inventory()),
        ...
        mp[stats_value::marksman_mod] = std::make_unique<stat_config>(actor_value::kMarksmanModifier,
            ...
            ini_setting::get_archery_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_archery_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_archery_mod_menu_inventory()),
            icon_keys::archery_mod);
        mp[stats_value::block_mod] = std::make_unique<stat_config>(actor_value::kBlockModifier,
            menu_keys::block_mod,
            ini_setting::get_block_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_block_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_block_mod_menu_inventory()),
            icon_keys::block_mod);
        mp[stats_value::smithing_mod] = std::make_unique<stat_config>(actor_value::kSmithingModifier,
            menu_keys::smithing_mod,
            ini_setting::get_smithing_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_smithing_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_smithing_mod_menu_inventory()),
        ...
        mp[stats_value::heavy_armor_mod] = std::make_unique<stat_config>(actor_value::kHeavyArmorModifier,
            ...
            ini_setting::get_heavy_armor_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_heavy_armor_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_heavy_armor_mod_menu_inventory()),
        ...
        mp[stats_value::light_armor_mod] = std::make_unique<stat_config>(actor_value::kLightArmorModifier,
            ...
            ini_setting::get_light_armor_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_light_armor_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_light_armor_mod_menu_inventory()),
        ...
        if (mod_manager->get_hand_to_hand()) {
            mp[stats_value::pickpocket_mod] = std::make_unique<stat_config>(actor_value::kPickpocketModifier,
                ...
                ini_setting::get_pickpocket_mod_string_ending(),
                menu_util::get_stats_menu(ini_setting::get_pickpocket_mod_menu()),
                menu_util::get_stats_inventory_menu(ini_setting::get_pickpocket_mod_menu_inventory()),
            ...
            mp[stats_value::lockpicking_mod] = std::make_unique<stat_config>(actor_value::kLockpickingModifier,
                ...
                ini_setting::get_lockpicking_mod_string_ending(),
                menu_util::get_stats_menu(ini_setting::get_lockpicking_mod_menu()),
                menu_util::get_stats_inventory_menu(ini_setting::get_lockpicking_mod_menu_inventory()),
        ...
        mp[stats_value::sneaking_mod] = std::make_unique<stat_config>(actor_value::kSneakingModifier,
            menu_keys::sneak_mod,
            ini_setting::get_sneak_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_sneak_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_sneak_mod_menu_inventory()),
            icon_keys::sneak_mod);
        mp[stats_value::alchemy_mod] = std::make_unique<stat_config>(actor_value::kAlchemyModifier,
            menu_keys::alchemy_mod,
            ini_setting::get_alchemy_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_alchemy_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_alchemy_mod_menu_inventory()),
        ...
        mp[stats_value::speechcraft_mod] = std::make_unique<stat_config>(actor_value::kSpeechcraftModifier,
            ...
            ini_setting::get_speech_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_speech_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_speech_mod_menu_inventory()),
        ...
        mp[stats_value::enchanting_mod] = std::make_unique<stat_config>(actor_value::kEnchantingModifier,
            ...
            ini_setting::get_enchanting_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_enchanting_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_enchanting_mod_menu_inventory()),
        ...
        mp[stats_value::alteration_mod] = std::make_unique<stat_config>(actor_value::kAlterationModifier,
            ...
            ini_setting::get_alteration_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_alteration_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_alteration_mod_menu_inventory()),
        ...
        mp[stats_value::conjuration_mod] = std::make_unique<stat_config>(actor_value::kConjurationModifier,
            ...
            ini_setting::get_conjuration_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_conjuration_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_conjuration_mod_menu_inventory()),
        ...
        mp[stats_value::destruction_mod] = std::make_unique<stat_config>(actor_value::kDestructionModifier,
            ...
            ini_setting::get_destruction_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_destruction_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_destruction_mod_menu_inventory()),
        ...
        mp[stats_value::illusion_mod] = std::make_unique<stat_config>(actor_value::kIllusionModifier,
            ...
            ini_setting::get_illusion_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_illusion_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_illusion_mod_menu_inventory()),
        ...
        mp[stats_value::restoration_mod] = std::make_unique<stat_config>(actor_value::kRestorationModifier,
            ...
            ini_setting::get_restoration_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_restoration_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_restoration_mod_menu_inventory()),
            icon_keys::restoration_mod);
        mp[stats_value::damage_arrow] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::damage_arrow,
            menu_util::get_stats_menu(ini_setting::get_damage_arrow_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_damage_arrow_menu_inventory()),
            icon_keys::damage_arrow);
        mp[stats_value::damage_left] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::damage_left,
            menu_util::get_stats_menu(ini_setting::get_damage_left_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_damage_left_menu_inventory()),
            icon_keys::damage_left);
        mp[stats_value::weapon_reach] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::weapon_reach,
            menu_util::get_stats_menu(ini_setting::get_weapon_reach_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_weapon_reach_menu_inventory()),
        ...
        mp[stats_value::weapon_reach_left] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            menu_util::get_stats_menu(ini_setting::get_weapon_reach_left_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_weapon_reach_left_menu_inventory()),
        ...
        mp[stats_value::weapon_base_damage] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            menu_util::get_stats_menu(ini_setting::get_weapon_base_damage_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_weapon_base_damage_menu_inventory()),
        ...
        mp[stats_value::weapon_base_damage_left] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            menu_util::get_stats_menu(ini_setting::get_weapon_base_damage_left_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_weapon_base_damage_left_menu_inventory()),
        ...
        mp[stats_value::weapon_stagger] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            menu_util::get_stats_menu(ini_setting::get_weapon_stagger_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_weapon_stagger_menu_inventory()),
        ...
        mp[stats_value::weapon_stagger_left] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            menu_util::get_stats_menu(ini_setting::get_weapon_stagger_left_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_weapon_stagger_left_menu_inventory()),
        ...
        mp[stats_value::weapon_crit_damage_rating] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            menu_util::get_stats_menu(ini_setting::get_weapon_crit_damage_rating_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_weapon_crit_damage_rating_menu_inventory()),
        ...
        mp[stats_value::weapon_crit_damage_rating_left] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            menu_util::get_stats_menu(ini_setting::get_weapon_crit_damage_rating_left_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_weapon_crit_damage_rating_left_menu_inventory()),
        ...
        mp[stats_value::fall_damage_mod] = std::make_unique<stat_config>(actor_value::kNone,
            ...
            ini_setting::get_fall_damage_mod_string_ending(),
            menu_util::get_stats_menu(ini_setting::get_fall_damage_mod_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_fall_damage_mod_menu_inventory()),
            menu_util::get_multiplier(ini_setting::get_fall_damage_mod_mult()),
            icon_keys::fall_damage_mod);
        mp[stats_value::warmth] = std::make_unique<stat_config>(actor_value::kNone,
            menu_keys::warmth,
            menu_util::get_stats_menu(ini_setting::get_warmth_menu()),
            menu_util::get_stats_inventory_menu(ini_setting::get_warmth_menu_inventory()),
            icon_keys::warmth);
        return mp;
    }
