    ...
    namespace GFx::Controls {
        ...
        public:
            ...
            void ScrollToIndex(double a_index) {
                ...
                [[maybe_unused]] const auto success = Invoke("scrollToIndex", nullptr, args.data(), args.size());
                assert(success);
            }
            ...
            void SetRendererList(Array& a_value) {
                ...
                [[maybe_unused]] const auto success = Invoke("setRendererList", nullptr, args.data(), args.size());
                assert(success);
            }
