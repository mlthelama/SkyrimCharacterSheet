...
class StatConfig {
public:
    StatConfig(RE::ActorValue a_actor, std::string a_display_name, std::string a_ending, bool a_show,
        StatsMenuValue a_stats_menu) :
        _actor(a_actor),
        _displayName(a_display_name), _ending(a_ending), _show(a_show), _statsMenu(a_stats_menu) {}

    StatConfig(RE::ActorValue a_actor, std::string a_display_name, std::string a_ending, bool a_show,
        StatsMenuValue a_stats_menu, int64_t a_value_multiplier) :
        _actor(a_actor),
        _displayName(a_display_name), _ending(a_ending), _show(a_show), _statsMenu(a_stats_menu),
        _valueMultiplier(a_value_multiplier) {}

    StatConfig(RE::ActorValue a_actor, std::string a_display_name, std::string a_ending, bool a_show,
        StatsMenuValue a_stats_menu, int64_t a_value_multiplier, float a_cap) :
        _actor(a_actor),
        _displayName(a_display_name), _ending(a_ending), _show(a_show), _statsMenu(a_stats_menu),
        _valueMultiplier(a_value_multiplier), _cap(a_cap) {}
    ...
    void logStatConfig(StatsValue a_stats_value) {
        logger::trace("name {}, actor {}, displayName ({}), ending {}, show {}, menu {}, valueMultiplier {}, cap {}"sv,
            a_stats_value, _actor, _displayName, _ending, _show, _statsMenu, _valueMultiplier, _cap);
    }
...
public:
    ...
    StatsMap init() {
        ...
        mp[StatsValue::name] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::nameString,
            *Settings::nameStringEnding, *Settings::name, StatsMenuValue::mNone);
        mp[StatsValue::race] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::raceString,
            *Settings::raceStringEnding, *Settings::race, StatsMenuValue::mNone);
        mp[StatsValue::level] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::levelString,
            *Settings::levelStringEnding, *Settings::level, StatsMenuValue::mNone);
        mp[StatsValue::perkCount] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::perkCountString,
            *Settings::perkCountStringEnding, *Settings::perkCount, StatsMenuValue::mNone);
        mp[StatsValue::height] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::heightString,
            *Settings::heightStringEnding, *Settings::height, getStatsMenu(*Settings::heightMenu));
        mp[StatsValue::equipedWeight] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::equipedWeightString,
            *Settings::equipedWeightStringEnding, *Settings::equipedWeight, getStatsMenu(*Settings::equipedWeightMenu));
        mp[StatsValue::weight] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::weightString,
            *Settings::weightStringEnding, *Settings::weight, getStatsMenu(*Settings::weightMenu));
        mp[StatsValue::armor] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::armorString,
            *Settings::armorStringEnding, *Settings::armor, getStatsMenu(*Settings::armorMenu));
        mp[StatsValue::damage] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::damageString,
        ...
        mp[StatsValue::health] = std::make_unique<StatConfig>(ActorValue::kHealth, *Settings::healthString,
            *Settings::healthStringEnding, *Settings::health, getStatsMenu(*Settings::healthMenu));
        mp[StatsValue::healthRatePer] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::healthRateString,
            *Settings::healthRateStringEnding, *Settings::healthRate, getStatsMenu(*Settings::healthRateMenu));
        mp[StatsValue::magicka] = std::make_unique<StatConfig>(ActorValue::kMagicka, *Settings::magickaString,
            *Settings::magickaStringEnding, *Settings::magicka, getStatsMenu(*Settings::magickaMenu));
        mp[StatsValue::magickaRatePer] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::magickaRateString,
            *Settings::magickaRateStringEnding, *Settings::magickaRate, getStatsMenu(*Settings::magickaRateMenu));
        mp[StatsValue::stamina] = std::make_unique<StatConfig>(ActorValue::kStamina, *Settings::staminaString,
            *Settings::staminaStringEnding, *Settings::stamina, getStatsMenu(*Settings::staminaMenu));
        mp[StatsValue::staminaRatePer] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::staminaRateString,
            *Settings::staminaRateStringEnding, *Settings::staminaRate, getStatsMenu(*Settings::staminaRateMenu));
        mp[StatsValue::resistDamage] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::resistDamageString,
            *Settings::resistDamageStringEnding, *Settings::resistDamage, getStatsMenu(*Settings::resistDamageMenu),
            _constStaticMultiplier, gameSettings->maxArmorResistance);
        ...
        mp[StatsValue::resistPoison] = std::make_unique<StatConfig>(ActorValue::kPoisonResist,
            *Settings::resistPoisonString, *Settings::resistPoisonStringEnding, *Settings::resistPoison,
            getStatsMenu(*Settings::resistPoisonMenu), _constStaticMultiplier, gameSettings->maxResistance);
        mp[StatsValue::resistFire] = std::make_unique<StatConfig>(ActorValue::kResistFire, *Settings::resistFireString,
            *Settings::resistFireStringEnding, *Settings::resistFire, getStatsMenu(*Settings::resistFireMenu),
            _constStaticMultiplier, gameSettings->maxResistance);
        mp[StatsValue::resistShock] = std::make_unique<StatConfig>(ActorValue::kResistShock,
            *Settings::resistShockString, *Settings::resistShockStringEnding, *Settings::resistShock,
            getStatsMenu(*Settings::resistShockMenu), _constStaticMultiplier, gameSettings->maxResistance);
        mp[StatsValue::resistFrost] = std::make_unique<StatConfig>(ActorValue::kResistFrost,
            *Settings::resistFrostString, *Settings::resistFrostStringEnding, *Settings::resistFrost,
            getStatsMenu(*Settings::resistFrostMenu), _constStaticMultiplier, gameSettings->maxResistance);
        mp[StatsValue::resistMagic] = std::make_unique<StatConfig>(ActorValue::kResistMagic,
            *Settings::resistMagicString, *Settings::resistMagicStringEnding, *Settings::resistMagic,
            getStatsMenu(*Settings::resistMagicMenu), _constStaticMultiplier, gameSettings->maxResistance);
        mp[StatsValue::oneHanded] = std::make_unique<StatConfig>(ActorValue::kOneHanded, *Settings::oneHandedString,
            *Settings::oneHandedStringEnding, *Settings::oneHanded, getStatsMenu(*Settings::oneHandedMenu));
        mp[StatsValue::twoHanded] = std::make_unique<StatConfig>(ActorValue::kTwoHanded, *Settings::twoHandedString,
            *Settings::twoHandedStringEnding, *Settings::twoHanded, getStatsMenu(*Settings::twoHandedMenu));
        mp[StatsValue::archery] = std::make_unique<StatConfig>(ActorValue::kArchery, *Settings::archeryString,
            *Settings::archeryStringEnding, *Settings::archery, getStatsMenu(*Settings::archeryMenu));
        mp[StatsValue::block] = std::make_unique<StatConfig>(ActorValue::kBlock, *Settings::blockString,
            *Settings::blockStringEnding, *Settings::block, getStatsMenu(*Settings::blockMenu));
        mp[StatsValue::smithing] = std::make_unique<StatConfig>(ActorValue::kSmithing, *Settings::smithingString,
            *Settings::smithingStringEnding, *Settings::smithing, getStatsMenu(*Settings::smithingMenu));
        mp[StatsValue::heavyArmor] = std::make_unique<StatConfig>(ActorValue::kHeavyArmor, *Settings::heavyArmorString,
            *Settings::heavyArmorStringEnding, *Settings::heavyArmor, getStatsMenu(*Settings::heavyArmorMenu));
        mp[StatsValue::lightArmor] = std::make_unique<StatConfig>(ActorValue::kLightArmor, *Settings::lightArmorString,
            *Settings::lightArmorStringEnding, *Settings::lightArmor, getStatsMenu(*Settings::lightArmorMenu));
        mp[StatsValue::pickpocket] = std::make_unique<StatConfig>(ActorValue::kPickpocket, *Settings::pickpocketString,
            *Settings::pickpocketStringEnding, *Settings::pickpocket, getStatsMenu(*Settings::pickpocketMenu));
        mp[StatsValue::lockpicking] =
            std::make_unique<StatConfig>(ActorValue::kLockpicking, *Settings::lockpickingString,
                *Settings::lockpickingStringEnding, *Settings::lockpicking, getStatsMenu(*Settings::lockpickingMenu));
        mp[StatsValue::sneak] = std::make_unique<StatConfig>(ActorValue::kSneak, *Settings::sneakString,
            *Settings::sneakStringEnding, *Settings::sneak, getStatsMenu(*Settings::sneakMenu));
        mp[StatsValue::alchemy] = std::make_unique<StatConfig>(ActorValue::kAlchemy, *Settings::alchemyString,
            *Settings::alchemyStringEnding, *Settings::alchemy, getStatsMenu(*Settings::alchemyMenu));
        mp[StatsValue::speech] = std::make_unique<StatConfig>(ActorValue::kSpeech, *Settings::speechString,
            *Settings::speechStringEnding, *Settings::speech, getStatsMenu(*Settings::speechMenu));
        mp[StatsValue::enchanting] = std::make_unique<StatConfig>(ActorValue::kEnchanting, *Settings::enchantingString,
            *Settings::enchantingStringEnding, *Settings::enchanting, getStatsMenu(*Settings::enchantingMenu));
        mp[StatsValue::alteration] = std::make_unique<StatConfig>(ActorValue::kAlteration, *Settings::alterationString,
            *Settings::alterationStringEnding, *Settings::alteration, getStatsMenu(*Settings::alterationMenu));
        mp[StatsValue::conjuration] =
            std::make_unique<StatConfig>(ActorValue::kConjuration, *Settings::conjurationString,
                *Settings::conjurationStringEnding, *Settings::conjuration, getStatsMenu(*Settings::conjurationMenu));
        mp[StatsValue::destruction] =
            std::make_unique<StatConfig>(ActorValue::kDestruction, *Settings::destructionString,
                *Settings::destructionStringEnding, *Settings::destruction, getStatsMenu(*Settings::destructionMenu));
        mp[StatsValue::illusion] = std::make_unique<StatConfig>(ActorValue::kIllusion, *Settings::illusionString,
            *Settings::illusionStringEnding, *Settings::illusion, getStatsMenu(*Settings::illusionMenu));
        mp[StatsValue::restoration] =
            std::make_unique<StatConfig>(ActorValue::kRestoration, *Settings::restorationString,
        ...
        mp[StatsValue::oneHandedPowerMod] = std::make_unique<StatConfig>(ActorValue::kOneHandedPowerModifier,
            *Settings::oneHandedPowerModString, *Settings::oneHandedPowerModStringEnding, *Settings::oneHandedPowerMod,
        ...
        mp[StatsValue::twoHandedPowerMod] = std::make_unique<StatConfig>(ActorValue::kTwoHandedPowerModifier,
            *Settings::twoHandedPowerModString, *Settings::twoHandedPowerModStringEnding, *Settings::twoHandedPowerMod,
        ...
        mp[StatsValue::speedMult] = std::make_unique<StatConfig>(ActorValue::kSpeedMult, *Settings::speedMultString,
        ...
        mp[StatsValue::carryWeight] =
            std::make_unique<StatConfig>(ActorValue::kCarryWeight, *Settings::carryWeightString,
        ...
        mp[StatsValue::meleeDamage] =
            std::make_unique<StatConfig>(ActorValue::kMeleeDamage, *Settings::meleeDamageString,
        ...
        mp[StatsValue::weaponSpeedMult] = std::make_unique<StatConfig>(ActorValue::kNone,
            *Settings::weaponSpeedMultString, *Settings::weaponSpeedMultStringEnding, *Settings::weaponSpeedMult,
            getStatsMenu(*Settings::weaponSpeedMultMenu), getMultiplier(*Settings::weaponSpeedMultMult));
        mp[StatsValue::leftWeaponSpeedMult] =
            std::make_unique<StatConfig>(ActorValue::kNone, *Settings::leftWeaponSpeedMultString,
                *Settings::leftWeaponSpeedMultStringEnding, *Settings::leftWeaponSpeedMult,
                getStatsMenu(*Settings::leftWeaponSpeedMultMenu), getMultiplier(*Settings::leftWeaponSpeedMultMult));
        ...
        mp[StatsValue::armorPerks] = std::make_unique<StatConfig>(ActorValue::kArmorPerks, *Settings::armorPerksString,
        ...
        mp[StatsValue::mass] = std::make_unique<StatConfig>(ActorValue::kMass, *Settings::massString,
        ...
        mp[StatsValue::shoutRecoveryMult] = std::make_unique<StatConfig>(ActorValue::kShoutRecoveryMult,
            *Settings::shoutRecoveryMultString, *Settings::shoutRecoveryMultStringEnding, *Settings::shoutRecoveryMult,
            getStatsMenu(*Settings::shoutRecoveryMultMenu), getMultiplier(*Settings::shoutRecoveryMultMult));
        mp[StatsValue::movementNoiseMult] = std::make_unique<StatConfig>(ActorValue::kMovementNoiseMult,
            *Settings::movementNoiseMultString, *Settings::movementNoiseMultStringEnding, *Settings::movementNoiseMult,
            getStatsMenu(*Settings::movementNoiseMultMenu), getMultiplier(*Settings::movementNoiseMultMult));
        mp[StatsValue::dragonSouls] =
            std::make_unique<StatConfig>(ActorValue::kDragonSouls, *Settings::dragonSoulsString,
        ...
        mp[StatsValue::beast] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::beastString,
            *Settings::beastStringEnding, *Settings::beast, StatsMenuValue::mNone);
        mp[StatsValue::xp] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::xpString,
        ...
        mp[StatsValue::marksmanMod] =
            std::make_unique<StatConfig>(ActorValue::kMarksmanModifier, *Settings::archeryModString,
                *Settings::archeryModStringEnding, *Settings::archeryMod, getStatsMenu(*Settings::archeryModMenu));
        mp[StatsValue::blockMod] = std::make_unique<StatConfig>(ActorValue::kBlockModifier, *Settings::blockModString,
            *Settings::blockModStringEnding, *Settings::blockMod, getStatsMenu(*Settings::blockModMenu));
        mp[StatsValue::smithingMod] =
            std::make_unique<StatConfig>(ActorValue::kSmithingModifier, *Settings::smithingModString,
                *Settings::smithingModStringEnding, *Settings::smithingMod, getStatsMenu(*Settings::smithingModMenu));
        ...
        mp[StatsValue::sneakingMod] =
            std::make_unique<StatConfig>(ActorValue::kSneakingModifier, *Settings::sneakModString,
                *Settings::sneakModStringEnding, *Settings::sneakMod, getStatsMenu(*Settings::sneakModMenu));
        mp[StatsValue::alchemyMod] =
            std::make_unique<StatConfig>(ActorValue::kAlchemyModifier, *Settings::alchemyModString,
                *Settings::alchemyModStringEnding, *Settings::alchemyMod, getStatsMenu(*Settings::alchemyModMenu));
        mp[StatsValue::speechcraftMod] =
            std::make_unique<StatConfig>(ActorValue::kSpeechcraftModifier, *Settings::speechModString,
                *Settings::speechModStringEnding, *Settings::speechMod, getStatsMenu(*Settings::speechModMenu));
        ...
        mp[StatsValue::illusionMod] =
            std::make_unique<StatConfig>(ActorValue::kIllusionModifier, *Settings::illusionModString,
                *Settings::illusionModStringEnding, *Settings::illusionMod, getStatsMenu(*Settings::illusionModMenu));
        ...
        mp[StatsValue::damageArrow] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::damageArrowString,
            *Settings::damageArrowStringEnding, *Settings::damageArrow, getStatsMenu(*Settings::damageArrowMenu));
        mp[StatsValue::damageLeft] = std::make_unique<StatConfig>(ActorValue::kNone, *Settings::damageLeftString,
