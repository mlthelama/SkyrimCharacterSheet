...
public:
    ...
    void logStatConfig(FactionValue a_stats_value) {
        logger::trace("name {}, displayname ({}), show {}, menu {}, displayIsValue {}"sv, a_stats_value, _displayName,
            _show, _menu, _displayIsValue);
    }
...
public:
    ...
    FactionMap init() {
        ...
        mp[FactionValue::greybeard] = std::make_unique<FactionConfig>(*Settings::greybeardString,
            *Settings::showFactions, getFactionMenu(*Settings::factionMenu));
        mp[FactionValue::bard] = std::make_unique<FactionConfig>(*Settings::bardString, *Settings::showFactions,
        ...
        mp[FactionValue::azura] = std::make_unique<FactionConfig>(*Settings::azuraName, *Settings::showChampion,
        ...
        mp[FactionValue::hermaeusMora] = std::make_unique<FactionConfig>(*Settings::hermaeusMoraName,
            *Settings::showChampion, getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::hircine] = std::make_unique<FactionConfig>(*Settings::hircineName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::malacath] = std::make_unique<FactionConfig>(*Settings::malacathName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::mehrunesDagon] = std::make_unique<FactionConfig>(*Settings::mehrunesDagonName,
            *Settings::showChampion, getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::mephala] = std::make_unique<FactionConfig>(*Settings::mephalaName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::meridia] = std::make_unique<FactionConfig>(*Settings::meridiaName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::molagBal] = std::make_unique<FactionConfig>(*Settings::molagBalName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::namira] = std::make_unique<FactionConfig>(*Settings::namiraName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::nocturnal] = std::make_unique<FactionConfig>(*Settings::nocturnalName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::peryite] = std::make_unique<FactionConfig>(*Settings::peryiteName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::sanguine] = std::make_unique<FactionConfig>(*Settings::sanguineName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::sheogorath] = std::make_unique<FactionConfig>(*Settings::sheogorathName,
            *Settings::showChampion, getFactionMenu(*Settings::championMenu), true);
        mp[FactionValue::vaermina] = std::make_unique<FactionConfig>(*Settings::vaerminaName, *Settings::showChampion,
            getFactionMenu(*Settings::championMenu), true);
