    ...
    namespace GFx {
        namespace Controls {
            ...
            public:
                ...
                void Open() {
                    [[maybe_unused]] const auto success = Invoke("open");
                    assert(success);
                }

                void Close() {
                    [[maybe_unused]] const auto success = Invoke("close");
                    assert(success);
                }
                ...
                void SetSize(double a_width, double a_height) {
                    ...
                    [[maybe_unused]] const auto success = Invoke("setSize", nullptr, args.data(), args.size());
                    assert(success);
                }
                ...
                void RemoveMovieClip() {
                    [[maybe_unused]] const auto success = Invoke("removeMovieClip");
                    assert(success);
                }
