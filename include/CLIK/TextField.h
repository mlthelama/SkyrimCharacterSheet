...
namespace CLIK {
    ...
    public:
        ...
        bool AddListener(Object& a_listener) {
            ...
            RE::GFxValue boolean;
            [[maybe_unused]] const auto success = Invoke("addListener", std::addressof(boolean), args.data(), kNumArgs);
            assert(success);
        ...
        double GetDepth() {
            RE::GFxValue number;
            [[maybe_unused]] const auto success = Invoke("getDepth", std::addressof(number));
            assert(success);
        ...
        void RemoveTextField() {
            [[maybe_unused]] const auto success = Invoke("removeTextField");
            assert(success);
        }

        void ReplaceSel(std::string_view a_newText) {
            enum { kNewText, kNumArgs };
            ...
            [[maybe_unused]] const auto success = Invoke("replaceSel", nullptr, args.data(), args.size());
            assert(success);
        }

        void ReplaceText(double a_beginIndex, double a_endIndex, std::string_view a_newText) {
            enum { kBeginIndex, kEndIndex, kNewText, kNumArgs };
            ...
            [[maybe_unused]] const auto success = Invoke("replaceText", nullptr, args.data(), args.size());
            assert(success);
        }
        ...
        void AppendText(std::string_view a_newText) {
            ...
            [[maybe_unused]] const auto success = Invoke("appendText", nullptr, args.data(), args.size());
            assert(success);
        }

        void AppendHtml(std::string_view a_newHtml) {
            enum { kNewHtml, kNumArgs };
            ...
            [[maybe_unused]] const auto success = Invoke("appendHtml", nullptr, args.data(), args.size());
            assert(success);
        }
        ...
        std::string GetLineText(double a_lineIndex) {
            ...
            RE::GFxValue str;
            [[maybe_unused]] const auto success = Invoke("getLineText", std::addressof(str), args.data(), args.size());
            assert(success);
        ...
        void CopyToClipboard(bool a_richClipboard, double a_startIndex, double a_endIndex) {
            enum { kRichClipboard, kStartIndex, kEndIndex, kNumArgs };
            ...
            [[maybe_unused]] const auto success = Invoke("copyToClipboard", nullptr, args.data(), args.size());
            assert(success);
        }
        ...
        void CutToClipboard(bool a_richClipboard, double a_startIndex, double a_endIndex) {
            ...
            [[maybe_unused]] const auto success = Invoke("cutToClipboard", nullptr, args.data(), args.size());
            assert(success);
        }
        ...
        void PasteFromClipboard(bool a_richClipboard, double a_startIndex, double a_endIndex) {
            ...
            [[maybe_unused]] const auto success = Invoke("pasteFromClipboard", nullptr, args.data(), args.size());
            assert(success);
        }
    };
}
